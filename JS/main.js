         ...
         fetch("https://api.rootnet.in/covid19-in/stats/testing/latest")
            ...
            fetch("https://api.covid19india.org/data.json")
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s1_6").innerHTML = data1.statewise[1].deltaconfirmed;
                    document.getElementById("s1_7").innerHTML = data1.statewise[1].deltarecovered;
                    document.getElementById("s1_8").innerHTML = data1.statewise[1].deltadeaths;
                })
            ...
            fetch("https://api.covid19india.org/data.json")
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s2_6").innerHTML = data1.statewise[2].deltaconfirmed;
                    document.getElementById("s2_7").innerHTML = data1.statewise[2].deltarecovered;
                    document.getElementById("s2_8").innerHTML = data1.statewise[2].deltadeaths; 
                }) 
            ...
            fetch("https://api.covid19india.org/data.json")
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s3_6").innerHTML = data1.statewise[3].deltaconfirmed;
                    document.getElementById("s3_7").innerHTML = data1.statewise[3].deltarecovered;
                    document.getElementById("s3_8").innerHTML = data1.statewise[3].deltadeaths; 
                })
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s4_6").innerHTML = data1.statewise[4].deltaconfirmed;
                    document.getElementById("s4_7").innerHTML = data1.statewise[4].deltarecovered;
                    document.getElementById("s4_8").innerHTML = data1.statewise[4].deltadeaths; 
                })
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s5_6").innerHTML = data1.statewise[5].deltaconfirmed;
                    document.getElementById("s5_7").innerHTML = data1.statewise[5].deltarecovered;
                    document.getElementById("s5_8").innerHTML = data1.statewise[5].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s6_6").innerHTML = data1.statewise[6].deltaconfirmed;
                    document.getElementById("s6_7").innerHTML = data1.statewise[6].deltarecovered;
                    document.getElementById("s6_8").innerHTML = data1.statewise[6].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s7_6").innerHTML = data1.statewise[7].deltaconfirmed;
                    document.getElementById("s7_7").innerHTML = data1.statewise[7].deltarecovered;
                    document.getElementById("s7_8").innerHTML = data1.statewise[7].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s8_6").innerHTML = data1.statewise[8].deltaconfirmed;
                    document.getElementById("s8_7").innerHTML = data1.statewise[8].deltarecovered;
                    document.getElementById("s8_8").innerHTML = data1.statewise[8].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s9_6").innerHTML = data1.statewise[9].deltaconfirmed;
                    document.getElementById("s9_7").innerHTML = data1.statewise[9].deltarecovered;
                    document.getElementById("s9_8").innerHTML = data1.statewise[9].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s10_6").innerHTML = data1.statewise[10].deltaconfirmed;
                    document.getElementById("s10_7").innerHTML = data1.statewise[10].deltarecovered;
                    document.getElementById("s10_8").innerHTML = data1.statewise[10].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s11_6").innerHTML = data1.statewise[11].deltaconfirmed;
                    document.getElementById("s11_7").innerHTML = data1.statewise[11].deltarecovered;
                    document.getElementById("s11_8").innerHTML = data1.statewise[11].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s12_6").innerHTML = data1.statewise[12].deltaconfirmed;
                    document.getElementById("s12_7").innerHTML = data1.statewise[12].deltarecovered;
                    document.getElementById("s12_8").innerHTML = data1.statewise[12].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s13_6").innerHTML = data1.statewise[13].deltaconfirmed;
                    document.getElementById("s13_7").innerHTML = data1.statewise[13].deltarecovered;
                    document.getElementById("s13_8").innerHTML = data1.statewise[13].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s14_6").innerHTML = data1.statewise[14].deltaconfirmed;
                    document.getElementById("s14_7").innerHTML = data1.statewise[14].deltarecovered;
                    document.getElementById("s14_8").innerHTML = data1.statewise[14].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s15_6").innerHTML = data1.statewise[15].deltaconfirmed;
                    document.getElementById("s15_7").innerHTML = data1.statewise[15].deltarecovered;
                    document.getElementById("s15_8").innerHTML = data1.statewise[15].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s16_6").innerHTML = data1.statewise[16].deltaconfirmed;
                    document.getElementById("s16_7").innerHTML = data1.statewise[16].deltarecovered;
                    document.getElementById("s16_8").innerHTML = data1.statewise[16].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s17_6").innerHTML = data1.statewise[17].deltaconfirmed;
                    document.getElementById("s17_7").innerHTML = data1.statewise[17].deltarecovered;
                    document.getElementById("s17_8").innerHTML = data1.statewise[17].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s18_6").innerHTML = data1.statewise[18].deltaconfirmed;
                    document.getElementById("s18_7").innerHTML = data1.statewise[18].deltarecovered;
                    document.getElementById("s18_8").innerHTML = data1.statewise[18].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s19_6").innerHTML = data1.statewise[19].deltaconfirmed;
                    document.getElementById("s19_7").innerHTML = data1.statewise[19].deltarecovered;
                    document.getElementById("s19_8").innerHTML = data1.statewise[19].deltadeaths; 
                })
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s20_6").innerHTML = data1.statewise[20].deltaconfirmed;
                    document.getElementById("s20_7").innerHTML = data1.statewise[20].deltarecovered;
                    document.getElementById("s20_8").innerHTML = data1.statewise[20].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s21_6").innerHTML = data1.statewise[21].deltaconfirmed;
                    document.getElementById("s21_7").innerHTML = data1.statewise[21].deltarecovered;
                    document.getElementById("s21_8").innerHTML = data1.statewise[21].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s22_6").innerHTML = data1.statewise[22].deltaconfirmed;
                    document.getElementById("s22_7").innerHTML = data1.statewise[22].deltarecovered;
                    document.getElementById("s22_8").innerHTML = data1.statewise[22].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s23_6").innerHTML = data1.statewise[23].deltaconfirmed;
                    document.getElementById("s23_7").innerHTML = data1.statewise[23].deltarecovered;
                    document.getElementById("s23_8").innerHTML = data1.statewise[23].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s24_6").innerHTML = data1.statewise[24].deltaconfirmed;
                    document.getElementById("s24_7").innerHTML = data1.statewise[24].deltarecovered;
                    document.getElementById("s24_8").innerHTML = data1.statewise[24].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s25_6").innerHTML = data1.statewise[25].deltaconfirmed;
                    document.getElementById("s25_7").innerHTML = data1.statewise[25].deltarecovered;
                    document.getElementById("s25_8").innerHTML = data1.statewise[25].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s26_6").innerHTML = data1.statewise[26].deltaconfirmed;
                    document.getElementById("s26_7").innerHTML = data1.statewise[26].deltarecovered;
                    document.getElementById("s26_8").innerHTML = data1.statewise[26].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s27_6").innerHTML = data1.statewise[27].deltaconfirmed;
                    document.getElementById("s27_7").innerHTML = data1.statewise[27].deltarecovered;
                    document.getElementById("s27_8").innerHTML = data1.statewise[27].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s28_6").innerHTML = data1.statewise[28].deltaconfirmed;
                    document.getElementById("s28_7").innerHTML = data1.statewise[28].deltarecovered;
                    document.getElementById("s28_8").innerHTML = data1.statewise[28].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s29_6").innerHTML = data1.statewise[29].deltaconfirmed;
                    document.getElementById("s29_7").innerHTML = data1.statewise[29].deltarecovered;
                    document.getElementById("s29_8").innerHTML = data1.statewise[29].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s30_6").innerHTML = data1.statewise[30].deltaconfirmed;
                    document.getElementById("s30_7").innerHTML = data1.statewise[30].deltarecovered;
                    document.getElementById("s30_8").innerHTML = data1.statewise[30].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s31_6").innerHTML = data1.statewise[31].deltaconfirmed;
                    document.getElementById("s31_7").innerHTML = data1.statewise[31].deltarecovered;
                    document.getElementById("s31_8").innerHTML = data1.statewise[31].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s32_6").innerHTML = data1.statewise[32].deltaconfirmed;
                    document.getElementById("s32_7").innerHTML = data1.statewise[32].deltarecovered;
                    document.getElementById("s32_8").innerHTML = data1.statewise[32].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s33_6").innerHTML = data1.statewise[33].deltaconfirmed;
                    document.getElementById("s33_7").innerHTML = data1.statewise[33].deltarecovered;
                    document.getElementById("s33_8").innerHTML = data1.statewise[33].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s34_6").innerHTML = data1.statewise[34].deltaconfirmed;
                    document.getElementById("s34_7").innerHTML = data1.statewise[34].deltarecovered;
                    document.getElementById("s34_8").innerHTML = data1.statewise[34].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s35_6").innerHTML = data1.statewise[35].deltaconfirmed;
                    document.getElementById("s35_7").innerHTML = data1.statewise[35].deltarecovered;
                    document.getElementById("s35_8").innerHTML = data1.statewise[35].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s36_6").innerHTML = data1.statewise[36].deltaconfirmed;
                    document.getElementById("s36_7").innerHTML = data1.statewise[36].deltarecovered;
                    document.getElementById("s36_8").innerHTML = data1.statewise[36].deltadeaths; 
                })
                fetch("https://api.covid19india.org/data.json")
                .then(one => {
                    return one.json();
                ...
                .then(data1 => {
                    ...
                    document.getElementById("s37_6").innerHTML = data1.statewise[37].deltaconfirmed;
                    document.getElementById("s37_7").innerHTML = data1.statewise[37].deltarecovered;
                    document.getElementById("s37_8").innerHTML = data1.statewise[37].deltadeaths; 
                })
